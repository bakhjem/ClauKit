...
* Delegate to `planner` agent to create an implementation plan in `./plans/<YYMMDD-HHMM>-<slug>/ck:plan.md`.
...
- `/ck:orchestrate` — multi-agent parallel fan-out (different concept from cook's sequential gated pipeline).
