...
- **Output format:** markdown by default. If `-o html` is passed, ALSO render a self-contained `plan.html` per the planning skill's `references/html-output.md` (markdown stays source of truth).
