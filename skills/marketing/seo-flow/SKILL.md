---
name: seo-flow
description: SEO workflow recipes — multi-step audits, migrations, recovery playbooks.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Flow

> SEO workflow recipes — multi-step audits, migrations, recovery playbooks.
...
- `plans/marketing/<campaign>/seo-flow.md` — analysis / audit / brief
