---
name: seo-cluster
description: Topic cluster modeling — pillar pages + supporting content, internal link graph.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Cluster

> Topic cluster modeling — pillar pages + supporting content, internal link graph.
...
- `plans/marketing/<campaign>/seo-cluster.md` — analysis / audit / brief
